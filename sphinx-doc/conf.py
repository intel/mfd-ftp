...
# MFD-Ftp documentation build configuration file, created by
...
latex_documents = [
    (master_doc, "mfd-ftp.tex", "MFD-Ftp Documentation", "author", "manual"),
]
...
man_pages = [(master_doc, "mfd-ftp", "MFD-Ftp Documentation", [author], 1)]
